...
public class Cls_Inventario {
    ...
    private final String SQL_SELECT_INVENTARIO = "SELECT inv_pro_codigo, descripcion, inv_entradas, inv_salidas, inv_stock FROM inventario INNER JOIN producto ON inv_pro_codigo = codigo";
