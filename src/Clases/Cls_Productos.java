...
public class Cls_Productos {
    ...
    private final String SQL_INSERT_PRODUCTOS = "INSERT INTO producto (codigo,descripcion,proveedor) values (?,?,?)";
    ...
    public int registrarProducto(String codigo, String descripcion, String proveedor){
        int res=0;
        try {
    ...
    public int actualizarProducto(String codigo, String descripcion, String proveedor, String codigo_old){
        String SQL = "UPDATE producto SET codigo='"+codigo+"',descripcion='"+descripcion+"', proveedor='"+proveedor+"' WHERE codigo='"+codigo_old+"'";
        int res=0;
        try {
